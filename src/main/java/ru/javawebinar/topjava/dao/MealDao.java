...
public class MealDao {
    ...
    static {
        ...
        mealList.add(new Meal(LocalDateTime.of(2018, 6, 3, 12, 30), "обед", 600));
        mealList.add(new Meal(LocalDateTime.of(2018, 6, 3, 17, 30), "ужин", 600));
        mealList.add(new Meal(LocalDateTime.of(2018, 6, 4, 8, 30), "завтрак", 600));
        mealList.add(new Meal(LocalDateTime.of(2018, 6, 4, 12, 30), "обед", 600));
        mealList.add(new Meal(LocalDateTime.of(2018, 6, 4, 17, 30), "ужин", 600));
    }
