...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void testCreate() throws Exception {
        ...
        assertMatch(mealService.getAll(UserTestData.USER_ID), returned, MEAL6, MEAL5, MEAL4, MEAL3, MEAL2, MEAL1);
    }
    ...
    void testGetBetween() throws Exception {
        mockMvc.perform(get(REST_URL + "between?startDate=2015-05-31&endDate=2015-05-31&startTime=12:00&endTime=20:00"))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
